 ...
 * This is the exact query from ChartDB's postgres-script.ts
 */

export function getPostgresQuery() {
    return `
/* PostgreSQL edition */
WITH fk_info AS (
...
export function getSqlServerQuery() {
    return `
SELECT '{"fk_info": [], "pk_info": [], "columns": [], "indexes": [], "tables": [], "views": [], "database_name": "' + DB_NAME() + '", "version": ""}' AS metadata_json_to_import;
    `;
}
